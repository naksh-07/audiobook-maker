...
flowchart TB
    subgraph Room1["🚪 Room 1: Creative Production Room"]
        ...
        PerfRealization --> Gate28{"Gate 2.8:<br/>Performance Fidelity Gate<br/>(Fail-Closed Pre-Mix QC)"}
...
- **Stage 3.5: Dramatic Performance Realization Layer & Gate 2.8 ([`audiobook_factory/performance/`](file:///c:/Users/Suraj/Documents/Antigravity/Audiobook/audiobook_factory/performance/))** *(ADR-032; see authoritative manual: [`docs/PERFORMANCE_REALIZATION_AND_ACTOR_DIRECTION.md`](file:///c:/Users/Suraj/Documents/Antigravity/Audiobook/docs/PERFORMANCE_REALIZATION_AND_ACTOR_DIRECTION.md))*:
  ...
  - **Priority-Based Multi-Take Banking ([`TakeBank`](file:///c:/Users/Suraj/Documents/Antigravity/Audiobook/audiobook_factory/performance/take_bank.py)):** Generates candidate performance takes scaled by dramatic priority: `standard` (1 take), `focused` (2 takes), `high` (2-3 takes), and `climactic` (3-4 takes across `standard`, `restraint`, `vulnerable`, and `exposed` variants).
  - **8-Dimensional Acoustic-Dramatic QC Engine ([`PerformanceEvaluator`](file:///c:/Users/Suraj/Documents/Antigravity/Audiobook/audiobook_factory/performance/evaluator.py)):** Evaluates candidate takes across 8 weighted dimensions (Naturalness 20%, Intent Match 15%, Emotional Match 15%, Pacing 15%, Subtext 10%, Prosody 10%, Character Consistency 8%, Relationship Consistency 7%) using mathematical signal analysis (`MathematicalAcousticAnalyzer`).
...
## 🌉 The 9 Metadata Bridges (Silo Elimination Matrix)

The system bridges all 9 critical producer-consumer metadata silos:
...
| **S7** | Quality Gate Suite | `gate_auditor.py` | `orchestrator.py` | Wired inline across pipeline stages (Gates 0, 1, 6A, 6C) and chapter production (Gates 2, 2.5, 2.8, 3.5, 5, 5.2, 5.3). |
