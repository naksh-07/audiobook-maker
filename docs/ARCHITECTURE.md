...
- **Autonomous Agent Director ([`audiobook_factory/agent_director.py`](file:///c:/Users/Suraj/Documents/Antigravity/Audiobook/audiobook_factory/agent_director.py))**:
  ...
  - **Commercial Cinematic Sound Design Subsystem ([`audiobook_factory/sound_design/`](file:///c:/Users/Suraj/Documents/Antigravity/Audiobook/audiobook_factory/sound_design/) - ADR-034 & ADR-035)**:
    ...
    - **Narrative Hard SFX & 4-Tier Creature Entities**: Directs major concussive impacts with proportional segment scheduling (eliminating 0.0s clumping) and models non-human creature vocalizations, respiration, locomotion, and body textures across behavioral states.
    ...
    - **Independent 9-Signal QC Auditor ([`SoundDesignQCAuditor`](file:///c:/Users/Suraj/Documents/Antigravity/Audiobook/audiobook_factory/sound_design/qc.py))**: Audits blueprints and timelines against 9 forensic signals with fail-closed PASS/WARN/FAIL reporting.
