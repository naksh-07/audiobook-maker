...
- **Stage 3: Dramatic Adaptation & Screenplay Engine ([`audiobook_factory/dramaturgy/`](file:///c:/Users/Suraj/Documents/Antigravity/Audiobook/audiobook_factory/dramaturgy/) & [`audiobook_factory/script_builder.py`](file:///c:/Users/Suraj/Documents/Antigravity/Audiobook/audiobook_factory/script_builder.py))** *(See comprehensive manual: [`docs/DRAMATIC_ADAPTATION_AND_SCREENPLAY.md`](file:///c:/Users/Suraj/Documents/Antigravity/Audiobook/docs/DRAMATIC_ADAPTATION_AND_SCREENPLAY.md))*:
  - **Dramaturgy Data Contracts ([`audiobook_factory/dramaturgy/contracts.py`](file:///c:/Users/Suraj/Documents/Antigravity/Audiobook/audiobook_factory/dramaturgy/contracts.py)):** Strictly typed Pydantic v2 schemas: [`DramaticBeat`](file:///c:/Users/Suraj/Documents/Antigravity/Audiobook/audiobook_factory/dramaturgy/contracts.py#L85-L113), [`CharacterDramaticObjective`](file:///c:/Users/Suraj/Documents/Antigravity/Audiobook/audiobook_factory/dramaturgy/contracts.py#L70-L83), [`SceneDramaticPlan`](file:///c:/Users/Suraj/Documents/Antigravity/Audiobook/audiobook_factory/dramaturgy/contracts.py#L118-L147), [`DramaticPlan`](file:///c:/Users/Suraj/Documents/Antigravity/Audiobook/audiobook_factory/dramaturgy/contracts.py#L149-L202), [`CharacterPerformanceProfile`](file:///c:/Users/Suraj/Documents/Antigravity/Audiobook/audiobook_factory/dramaturgy/contracts.py#L207-L225), [`PerformanceBible`](file:///c:/Users/Suraj/Documents/Antigravity/Audiobook/audiobook_factory/dramaturgy/contracts.py#L227-L272), and [`DramaticValidationResult`](file:///c:/Users/Suraj/Documents/Antigravity/Audiobook/audiobook_factory/dramaturgy/contracts.py#L290-L323).
  - **Organic Scene Analysis Engine ([`SceneAnalyzer`](file:///c:/Users/Suraj/Documents/Antigravity/Audiobook/audiobook_factory/dramaturgy/scene_analyzer.py)):** Discovers organic scene boundaries using narrative time patterns (English & Hindustani `TIME_PATTERNS`), location transitions (`LOCATION_PATTERNS`), and typographic break indicators with depth buffering ($\ge 280$ words). Derives scored multi-signal classification across 9 dramatic modes, dramatic questions, stakes, opening/closing states, and audience dramatic irony (`listener_knowledge_state`) linked to upstream epistemic memory.
  - **Beat Planning & Dynamic Actioning ([`BeatPlanner`](file:///c:/Users/Suraj/Documents/Antigravity/Audiobook/audiobook_factory/dramaturgy/beat_planner.py)):** Slices scenes into atomic beats (2 to 5 per scene based on dramatic complexity). Derives Stanislavski/Mamet transitive actioning verbs (`threaten`, `deflect`, `reassure`, `probe`, `challenge`, `command`), dual-layer emotions (surface delivery vs suppressed underlying state), conservative subtext with strict confidence classification, and sampled continuous tension curves ($0.05$ to $0.98$).
  - **Novel-Scale Beat-Aligned Chunk Slicing ([`slice_chapter_by_beats()`](file:///c:/Users/Suraj/Documents/Antigravity/Audiobook/audiobook_factory/dramaturgy/beat_planner.py#L321-L429)):** Completely eliminates the historical 1,200-word cut boundary flaw by aligning processing chunks strictly to natural scene breaks and intra-scene beat boundaries (`paras_per_beat`), preserving complete dramatic arcs and passing rolling conversational memory across chunks.
  - **Performance Bible Generator ([`PerformanceBibleGenerator`](file:///c:/Users/Suraj/Documents/Antigravity/Audiobook/audiobook_factory/dramaturgy/performance_bible.py)):** Projects canonical character lore into actionable vocal delivery directives across 6 sociolect presets: `'COLD_CYNIC'` (pacing 0.92, chest resonance, 1.2s pregnant pause), `'CAUSTIC_ARISTOCRAT'` (pacing 1.04, verbal fencing), `'THARKI_BARD'` (pacing 1.08, lyrical colloquialism), `'RUSTIC_WARRIOR'` (pacing 0.96, guttural bluntness), `'VULNERABLE_SCHOLAR'` (pacing 1.02, rapid hesitant stammer), and `'DEFAULT_DRAMATIC'`. Generates standard objective cinematic observer profiles for the Narrator.
  - **Fail-Closed Gate 2.5 Dramatic Fidelity & Character Arc Validator ([`DramaticValidator`](file:///c:/Users/Suraj/Documents/Antigravity/Audiobook/audiobook_factory/dramaturgy/dramatic_validator.py) & [`audit_gate2_5_dramatic_fidelity()`](file:///c:/Users/Suraj/Documents/Antigravity/Audiobook/audiobook_factory/gate_auditor.py#L305-L371)):** 5-pillar independent verification audit:
    1. *Structural & Index Integrity:* Monotonic 1-based indexing, valid scene/beat ID links.
    2. *Character Epistemics:* Blocks unmotivated disclosure of secrets marked `UNKNOWN` in memory (`EPISTEMIC_ISOLATION_BREACH`).
    3. *Anti-Emotional Teleportation:* Flags volatile unbridged jumps (`calm` $\rightarrow$ `bellowing_rage`, `whispering` $\rightarrow$ `bellowing_rage`).
    4. *Dramatic Fidelity Guard:* Detects dropped or heavily mutated dialogue from source narrative.
    5. *Creative Overreach Guard:* Enforces "Nothing Above Source", blocking unsupported high-confidence subtext and fabricated SFX action cues.
