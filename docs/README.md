...
|---|---|---|
| **[🏛️ Architecture Blueprint](file:///c:/Users/Suraj/Documents/Antigravity/Audiobook/docs/ARCHITECTURE.md)** | Deep dive into the 4-Room Architecture, the 5 discrete stems, the 8 metadata bridges, and the autonomous pipeline lifecycle. | System Architects, Engineers |
...
| **[📚 API Reference](file:///c:/Users/Suraj/Documents/Antigravity/Audiobook/docs/API_REFERENCE.md)** | Pydantic v2 data contracts (`CreativeManifest`, `ScreenplaySegment`, `StemLedger`), core engine classes, and public functions across 29 modules. | Backend Developers, Integrators |
...
| **[🛠️ Developer & Contributor Guide](file:///c:/Users/Suraj/Documents/Antigravity/Audiobook/docs/DEVELOPER_GUIDE.md)** | Local environment setup, virtual environment, running tests (243 passing), invariants, Sound Bank ingestion, and troubleshooting. | Contributors, Maintainers |
