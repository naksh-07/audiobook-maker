...
UCS_RULES = [
    (("sword", "blade", "parry", "clash", "sheathe", "draw", "तलवार", "खंजर", "ब्लेड"), "WEAPSwd"),
    (("knife", "dagger"), "WEAPKnf"),
    (("armor_plate", "plate_armor", "armor", "cuirass", "chainmail", "iron_shield"), "WEAPMtl"),
    (("plate", "dish", "bowl", "cup", "spoon", "fork", "tableware", "tray", "tankard", "थाली", "कटोरा", "चम्मच", "बर्तन", "प्याला"), "DOMETabl"),
    (("mace", "warhammer", "blunt", "club"), "WEAPBlun"),
    (("bow", "arrow", "whipcrack", "flyby", "arrow_whistle"), "WEAPBow"),
    (("punch", "kick", "fist", "strike"), "FGHFPun"),
    (("bone", "snap", "flesh", "cartilage", "blood", "squelch", "tear", "हड्डी", "मांस"), "GOREAnat"),
    (("footstep", "walk", "run", "gravel", "boots", "कदम", "पैरों"), "FOLEFoot"),
    (("cloth", "belt", "leather"), "FOLEMov"),
    (("body", "fall", "thud", "collapse", "गिरा", "पटक"), "IMPTBody"),
    (("sub_drop", "lfe", "thump", "solar_plexus", "shockwave"), "LFEDrop"),
    (("metal", "clank", "chain", "anvil"), "IMPTMtl"),
    (("wood", "timber", "floor"), "IMPTWod"),
    (("door", "gate", "latch", "दरवाजा", "किवाड़"), "DOORWood"),
