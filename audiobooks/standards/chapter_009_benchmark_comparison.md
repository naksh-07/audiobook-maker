...
|---|---|---|---|
| Nenneke maternal irritation ('बकचोदी' / 'माँ' / 'लफ़ंगा') | Matched: बकचोदी, माँ, लफ़ंगा | Matched: बकचोदी, माँ, लफ़ंगा | **PASSED** |
| Gatekeeper flirtation ('गांड' / 'चिकोटी' / 'चोटी') | Matched: गांड, चिकोटी, चोटी | Matched: गांड, चिकोटी, चोटी | **PASSED** |
| Plum vodka behind alchemical folios ('बेर' / 'शराब' / 'कीमिया') | Matched: बेर, शराब, कीमिया | Matched: बेर, शराब, कीमिया | **PASSED** |
| Troll under the bridge ('पुल' / 'ट्रोल' / 'टोल') | Matched: पुल, ट्रोल, टोल | Matched: पुल, ट्रोल, टोल | **PASSED** |
| Forktail dragon pet ('ड्रैगन' / 'बेटी' / 'पालतू') | Matched: ड्रैगन, पालतू | Matched: ड्रैगन, पालतू | **PASSED** |
| Impotence soup ('नामर्दी' / 'कमजोरी' / 'सूप') | Matched: नामर्दी, सूप | Matched: नामर्दी, सूप | **PASSED** |
| Unicorn virgins & cherry ('सील' / 'कौमार्य' / 'यूनिकॉर्न') | Matched: सील, कौमार्य, यूनिकॉर्न | Matched: सील, कौमार्य, यूनिकॉर्न | **PASSED** |
| Roderick de Novembre history ('इतिहास' / 'रॉड्रिक' / 'नोवम्ब्रे') | Matched: रॉड्रिक, इतिहास | Matched: रॉड्रिक, इतिहास | **PASSED** |
| Southern complaints ('पेशाब' / 'नहाती' / 'मच्छर') | Matched: पेशाब, नहाती, मच्छर | Matched: पेशाब, नहाती, मच्छर | **PASSED** |
| Gulet scandal & gelding ('बधिया' / 'अंडकोष' / 'तारकोल') | Matched: बधिया, तारकोल | Matched: बधिया, तारकोल | **PASSED** |
...
- **[T7] Character Language Profile Alignment**: `GateStatus.PASS` — Character voice profiles verified.
- **[T8] Mature Register & Intensity Preservation**: `GateStatus.PASS` — Max delta: 0.3
